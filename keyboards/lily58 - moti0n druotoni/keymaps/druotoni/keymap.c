...
* `-----------------------------------------/       /     \      \-----------------------------------------'
*                   | LAlt |  Up  | Space| /  SPC  /       \Enter \  |BackSP| Low  | RALT|
*                   |      |      |      |/       /         \      \ |      |      |      |
*                   `----------------------------'           '------''--------------------'
*/
    [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_SPC,  KC_ENT,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                        KC_LBRC, KC_LALT, KC_LGUI, TT(_RAISE),   TT(_LOWER),   KC_BSPC,   KC_RALT, KC_RBRC
    ),
...
*/
    ...
    KC_F11,   KC_F12,     KC_UP,   _______ , _______,         _______,                        KC_HOME,    KC_PGUP,    KC_PSCR,    RCTL(FR_Y),    RCTL(KC_RIGHT), LCTL(FR_V),
    _______,  KC_LEFT,    KC_DOWN, KC_RIGHT, RCTL(FR_Z),      KC_BSPC,                        _______,    _______,    _______,    _______,       RCTL(FR_C),        _______,
    _______,  _______,    _______, _______,  LALT(KC_TAB),    RCTL(FR_X), KC_SPC, KC_ENT,    KC_END,     KC_PGDN,    RCTL(FR_A), RCTL(FR_S),    RCTL(FR_S),        _______,
    _______,  TT(_RAISE), _______, _______,                                                   KC_DELETE,    _______,  KC_APP,     QK_BOOT),
